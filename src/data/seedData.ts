...
export const AI_DIMENSION_NAMES = ['基础理论', 'AI核心', '工程落地', '场景转化', '合规软技', '前沿创新']
export const AI_DIMENSION_MAX = [15, 30, 30, 10, 10, 5]

export const MODELER_DIMENSION_NAMES = ['软件操作', '建模技术', 'UV纹理', '美术素养', '渲染光照', '项目实践', '动画绑定']
export const MODELER_DIMENSION_MAX = [20, 25, 15, 10, 10, 15, 5]

export function getDimensionNames(position: Position): string[] {
  return position === 'ai_engineer' ? AI_DIMENSION_NAMES : MODELER_DIMENSION_NAMES
}

export function getDimensionMax(position: Position): number[] {
  return position === 'ai_engineer' ? AI_DIMENSION_MAX : MODELER_DIMENSION_MAX
}

export const AI_TALENTS: SeedTalent[] = [
...
export const MODELER_TALENTS: SeedTalent[] = [
...
export const MODELER_JOBS: SeedJob[] = [
